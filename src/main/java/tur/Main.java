...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        teacherService.writeTeacherDataToFile("C:\\Users\\Dankos\\OneDrive\\Рабочий стол\\1.txt");
        studentService.writeStudentDataToFile("C:\\Users\\Dankos\\OneDrive\\Рабочий стол\\2.txt");
